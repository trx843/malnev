...
type GroupEventSettingsContainerProps = CtrlGroupEventSettingsState &
  IMappedDispatchesToGroupEventSettingsProps;

class CtrlGroupEventSettingsContainer extends Component<
  GroupEventSettingsContainerProps,
  IGroupEventSettingsContainerState
> {
  private baseUrl: string = `${apiBase}/GroupsCtrlEventTypes`;
          ...
          actionColumns={[
            {
              ...
              headerComponent: "ctrlgroupWebCheckBoxHeader",
              cellRenderer: "ctrlgroupWebCheckboxRenderer",
              minWidth: 300,
            ...
            },
            {
              ...
              headerComponent: "ctrlgroupMailCheckBoxHeader",
              cellRenderer: "ctrlgroupMailCheckboxRenderer",
              minWidth: 300,
              headerComponentParams: {
                clicked: (checked: boolean) => {
                  this.props.tableItems.forEach(
...
const mapStateToProps = (state: StateType): CtrlGroupEventSettingsState => {
  return {
    ...state.ctrlgroupEventSettings,
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(CtrlGroupEventSettingsContainer);
