...
import styles from "./testingLaboratoriesForOilAndOilProducts.module.css";
...
export const TestingLaboratoriesForOilAndOilProducts: React.FC<IProps> = ({
  ...
  React.useEffect(() => {
    dispatch(setIsIL(true))
  }, []);

  const { typicalPlanCard, testingLaboratoriesOfOilAndPetroleumProducts } =
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <AgGridTable
        rowData={testingLaboratoriesOfOilAndPetroleumProducts}
