...
import { groupEventSettingsBtnDisabled, groupMailChecked } from '../../../actions/groupeventsettings/creators';
...
export const GroupMailCheckBoxCell: FunctionComponent<IGroupMailCheckBoxCellProps> = (props: IGroupMailCheckBoxCellProps) => {
