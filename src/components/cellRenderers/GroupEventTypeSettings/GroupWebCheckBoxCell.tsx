...
import { groupEventSettingsBtnDisabled, groupWebChecked } from '../../../actions/groupeventsettings/creators';
...
export const GroupWebCheckBoxCell: FunctionComponent<IGroupWebCheckBoxCellProps> = (props: IGroupWebCheckBoxCellProps) => {
