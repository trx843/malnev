...
import { CompositionItem } from "../../../../classes";
...
interface TableActActionsProps extends RendererProps<CompositionItem> {
...
export const TableActions: FC<TableActActionsProps> = ({ onDelete, data }) => {
  ...
  const handleEdit = () => {
    modalsState.setModal({
      type: ReportTypeModals.EDIT_REPORT_MODAL,
      visible: true,
      payload: data
    })
  };
  ...
  return (
    <div className="ais-table-actions">
      ...
      <Can
        I={ActionsEnum.View}
        a={elementId(VerificationActsElements[VerificationActsElements.DelApp])}
      >
        <Tooltip
          arrowPointAtCenter
