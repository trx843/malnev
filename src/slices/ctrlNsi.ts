...
const ctrlNsiSlice = createSlice({
    name: "ctrlNsi",
    initialState,
    reducers: {
...
//exports
export default ctrlNsiSlice.reducer;
export const ctrlNsiActions = ctrlNsiSlice.actions;
export const ctrlNsi = (state: StateType): CtrlNsiStateType => state.ctrlNsi;

//types
export type CtrlNsiStateType = typeof initialState;
